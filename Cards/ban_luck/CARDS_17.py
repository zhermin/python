...
class Money:
    ...
    def saveHigh(self):
        ...
        h.write((getName() + " | $" + str(self.cash)).center(77))
        h.write("\n")
        h.close()
...
def play(comp = None):
    ...
    if numPlayer == 15: # Free Hands
        ...
        print ("Python drew a free hand! He has decided to re-draw!")
        print ("\nYour hand : " + '%s' % ', '.join(map(str, player_hand)))
        print ("Python hand : " + '%s' % ', '.join(map(str, cpu_hand)))
        dough.win(6)
        replay(re)
    ...
    if numPlayer > 20 and numCpu > 20 and numCpu == numPlayer: # Check for BAN LUCK / BAN BAN draws
        ...
        if numPlayer == 22:
            ...
            if numCpu == 22:
                print ("Python hand : " + '%s' % ', '.join(map(str, cpu_hand)))
                print ("")
                print ("Python drew a BAN BAN! Python beat your hand! You lose triple!")
                dough.lose(2)
                replay(re)
    ...
    while True:
        ...
        if re == 2: # Competitive
            if dough.round == 4:
                ...
                while True:
                    quitGame = input("Type anything to view match history or '/r' to play again or '/q' to exit the game >>> ").lower()
                    if quitGame == "/q":
                        exit()
                    elif quitGame == "/r":
                        dough.reset()
        ...
        if dough.cash < 5: # Casual
            ...
            print ("Type '/h' to view match history or '/r' to play again or '/q' to exit the game!")
